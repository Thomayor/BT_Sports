...
export default function ShowGame({ game, sport, playground, teams }: ShowGameProps) {
    ...
    return (
        <AppLayout
            title="Game"
        >   
            <div className="max-w-xl rounded-lg mt-10 mx-auto py-10 sm:px-6 lg:px-8 border-solid border-2 border-sky-600">
                ...
                <div className="mt-6 border-t border-gray-100">
                    <dl className="divide-y divide-gray-100">
                        ...
                        <div className="flex justify-start">
                            <PrimaryButton
                                className='opacity-80 mt-6 bg-sky-500 mr-2'
                            >
                            ...
                            {userID === game.user_id && (
                                <>
                                    <PrimaryButton
                                        className='opacity-80 mt-6 bg-lime-500 mr-2'
                                    >
                                        <Link href="edit/">
                                    ...
                                    <PrimaryButton
                                        className='opacity-80 mt-6 bg-rose-700'
                                    >
                                        <Link
                                            href=""
                                            onClick={deleteGame}
